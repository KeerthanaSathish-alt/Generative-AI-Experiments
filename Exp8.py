...
Task:  
{code_task}  
Return only a complete and properly indented Python 
program.  
"""  
...
# 5. Display Results  
print("AI-POWERED CODE GENERATION AND 
DEBUGGING ASSISTANT")  
print("=" * 60)  
