...
def calculate_relevance(prompt, response):
    """
    Calculates keyword overlap relevance score.
    """
    stop_words = {
        "the", "a", "an", "is", "are", "was", "were",
        "to", "of", "in", "on", "for", "and", "or",
        "with", "what", "how", "why", "write",
        "explain", "describe", "give", "about"
    }
    prompt_words = set(
    ...
    with gr.Row():
        with gr.Column():
            prompt_input = gr.Textbox(
                label="Enter Prompt",
                placeholder=
                "Example: Explain the applications of Generative AI in education.",
                lines=6
            )
